...
namespace WSplitTimer
{
    public class WSplit : Form
    {
        ...
        private void displayDetail()
        {
            ...
            if ((this.split.RunTitle != "") && Settings.Profile.ShowTitle)
            {
                height += 0x12;
            }
            if ((this.split.RunGoal != "") && Settings.Profile.ShowGoal)
            {
                height += 0x12;
            }
                        ...
                        if (!Settings.Profile.BackgroundBlack)
                        {
                            ...
                            if (wsplit.currentDispMode == DisplayMode.Detailed)
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        if (Settings.Profile.BackgroundPlain)
                                            bgGraphics.FillRectangle(new SolidBrush(ColorSettings.Profile.TitleBackPlain), titleX, titleY, wsplit.Width, 36);
                                        else
                                        {
